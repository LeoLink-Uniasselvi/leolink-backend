...
export class CreateLikeDto {
  @ApiPropertyOptional({
    format: 'uuid',
    description: 'Identificador do post a ser curtido',
  ...
  @ApiPropertyOptional({
    format: 'uuid',
    description: 'Identificador do comentario a ser curtido',
  ...
  @ApiProperty({
    format: 'uuid',
    description: 'Identificador do usuario que esta curtindo',
